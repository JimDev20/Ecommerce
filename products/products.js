...
function renderProducts(){
  ...
  g.innerHTML=page.map(function(p,i){
    ...
    return '<div class="col-lg-3 col-md-4 col-6 mb-4 scroll-animate stagger-'+((i%8)+1)+'"><div class="card product-card h-100"><a href="../product-details/?product='+encodeURIComponent(p.name)+'" class="text-decoration-none"><div class="overflow-hidden">'+
      ...
      '<a href="../product-details/?product='+encodeURIComponent(p.name)+'" class="btn btn-sm btn-outline-secondary flex-grow-1"><i class="bi bi-eye me-1"></i>View Details</a>'+
